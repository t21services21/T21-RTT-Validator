-- ============================================
-- T21 SERVICES - COMPLETE SUPABASE TABLE FIX
-- This script fixes all column name discrepancies
-- ============================================

-- First, let's drop existing tables that have wrong structures
-- (Only run this if you're okay with losing existing data!)
-- DROP TABLE IF EXISTS learning_materials, material_downloads, assignments, assignment_submissions, 
-- video_library, video_views, announcements, cancer_pathways, mdt_meetings, clinics, appointments CASCADE;
...
-- ============================================
-- CANCER PATHWAYS TABLE (FIXED to match your code)
-- ============================================
